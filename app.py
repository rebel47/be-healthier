            ...
            with tab1:
                ...
                if st.session_state.analysis_result:
                    ...
                    if st.button("Add to Food Log"):
                        total_calories = (result['calories'] if image_type == "Food Label"
                        ...
                        entry = {
                            ...
                            'protein': float(result.get('protein', 0)) if image_type == "Food Label" else 0,
                            'carbs': float(result.get('carbohydrates', 0)) if image_type == "Food Label" else 0,
                            'fat': float(result.get('fat', 0)) if image_type == "Food Label" else 0
                        }
                        save_food_log(entry)
